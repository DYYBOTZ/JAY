...
│🎭 Creator : Dani
║🎭 Owner : DANIMAKER ダフ
│🎭 Owner Number : 081251549899
║🎭 Prefix :MULTI
│▬▭「 INFO OWNER ダフ️ 」▭▬
[ 🇬🇧 Please ask the owner for a password first so you can use the DaniMaker Bot ]
[ 🇲🇨 Silahkan Meminta Password Kepada Owner Terlebih Dahulu Agar Bisa Menggunakan Bot DaniMaker 」
[ 🇯🇵 DaniMaker Bot を使用できるように、最初に所有者にパスワードを尋ねてください
[ 🇵🇹 Por favor, peça uma senha ao proprietário primeiro para que você possa usar o DaniMaker Bot ]'
 `
}
